...
def application_train_test(num_rows = None, nan_as_category = False):
    ...
    feats = [f for f in df.columns if f not in ['TARGET','SK_ID_CURR','SK_ID_BUREAU','SK_ID_PREV','index','EXT_SOURCE_1', 'EXT_SOURCE_2', 'EXT_SOURCE_3']]
    for col in ext_cols:
...
def kfold_lightgbm(df, num_folds, stratified = False, debug= False):
    ...
    train_df = train_df[train_df["CODE_GENDER"] != 2]
    test_df = test_df[test_df["CODE_GENDER"] != 2]
